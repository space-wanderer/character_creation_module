...
def attack(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'mage':
        return (f'{char_name} {caused_damage} {5 + randint(5, 10)}')
    if char_class == 'healer':
        return (f'{char_name} {caused_damage} {5 + randint(-3, -1)}')
...
def special(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'mage':
        return (f'{char_name} {applied_the_skill} «Атака {5 + 40}»')
    if char_class == 'healer':
        return (f'{char_name} {applied_the_skill} «Защита {10 + 30}»')
    return (f'{char_name} не применил специальное умение')
